...
class IdentifiableNounRepositoryTest {
    private val log = LoggerFactory.getLogger(IdentifiableNounRepositoryTest::class.java)!!

    @Autowired
    private lateinit var repository: IdentifiableNounRepository
